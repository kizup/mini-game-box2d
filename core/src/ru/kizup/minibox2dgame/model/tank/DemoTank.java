...
public abstract class DemoTank implements Vehicle, Steerable<Vector2> {
    ...
    public DemoTank(float width, float length, Vector2 position, float angle, float power, float maxSteerAngle, float maxSpeed, World world, int koefRotation) {
